...
export function SectionMorphBlob() {
  ...
  return (
    <motion.div
      className="pointer-events-none fixed left-1/2 top-1/2 z-0 h-[500px] w-[500px] -translate-x-1/2 opacity-[0.06] blur-3xl"
      style={{
        y,
        scale,
        borderRadius,
        background: "linear-gradient(135deg, var(--color-wine), var(--color-amber), var(--color-gold))",
      }}
    />
  );
}
